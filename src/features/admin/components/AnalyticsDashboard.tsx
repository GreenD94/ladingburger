...
import TopSellingItems from '@/features/analytics/components/TopSellingItems';
import CustomerAnalytics from '@/features/analytics/components/CustomerAnalytics';
import PeakHoursChart from '@/features/analytics/components/PeakHoursChart';
import { Grid, Paper, Typography, Box } from '@mui/material';
import ErrorBoundary from '@/features/analytics/components/ErrorBoundary';
