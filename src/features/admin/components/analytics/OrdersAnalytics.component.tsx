...
import { useOrdersAnalytics } from '@/features/admin/hooks/useOrdersAnalytics.hook';
import { Order } from '@/features/database/types/index.type';
import { OrdersFiltersState } from '../orders/OrdersFilters.component';
...
export const OrdersAnalytics: React.FC<OrdersAnalyticsProps> = ({
  ...
  const dateRange = filters && filters.dateRange.start.getTime() !== 0 && filters.dateRange.end.getTime() !== 0
    ? {
